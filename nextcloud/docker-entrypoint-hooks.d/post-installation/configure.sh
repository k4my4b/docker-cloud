...
php occ config:system:set --value="OC\\Preview\\Imaginary" -- enabledPreviewProviders 0
php occ config:system:set --value="http://$IMAGINARY_HOST:$IMAGINARY_PORT" -- preview_imaginary_url
